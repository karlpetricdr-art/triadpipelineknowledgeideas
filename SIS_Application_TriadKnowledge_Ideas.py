...
"""
                # NEPOSREDEN REST KLIC (Uporaba v1beta za najboljšo kompatibilnost s Free tier in system instructions)
                ...
                # Payload struktura za Google Gemini REST API
                payload = {
                    "contents": [{
                        "parts": [{
